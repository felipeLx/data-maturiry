...
import gspread
from utils import delete_pdfs, merge_pdfs, send_email_with_attachment, download_button
...
page01 = page01.replace("{{business}}", business)
page01 = page01.replace("{{formatted_median}}", formatted_median)
page01 = page01.replace("{{value_0}}", value_0)
page01 = page01.replace("{{text_0}}", text_0)
page01 = page01.replace("{{value_1}}", value_1)
page01 = page01.replace("{{text_1}}", text_1)
page01 = page01.replace("{{value_2}}", value_2)
page01 = page01.replace("{{text_2}}", text_2)
page01 = page01.replace("{{value_3}}", value_3)
page01 = page01.replace("{{text_3}}", text_3)
page01 = page01.replace("{{value_4}}", value_4)
page01 = page01.replace("{{text_4}}", text_4)
page01 = page01.replace("{{value_5}}", value_5)
page01 = page01.replace("{{text_5}}", text_5)
page01 = page01.replace("{{today_0}}", today_0)
page01 = page01.replace("{{future_0}}", future_0)
page01 = page01.replace("{{logos}}", logos)
...
# Display pages
st.components.v1.html(page02, height=600)
